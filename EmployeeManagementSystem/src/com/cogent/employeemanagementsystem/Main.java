...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 // Employee[] employees = employeeService.getEmployees();
		  //employeeService.deleteAllEmployees(); Employee employeeT= new Employee("sisi","add","min",1000.0f,"PA","management");
		  //employeeService.upddateEmployee("shaotong8", employeeT); for(Employee employe
		  //: employees) { System.out.println(employe); }
